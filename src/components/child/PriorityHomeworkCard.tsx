  ...
  return (
    <div className="rounded-radius-xl bg-gradient-to-r from-honey-100 via-cream-50 to-white p-5 shadow-elevation-floating ring-1 ring-honey-200">
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="rounded-full bg-cream-100/80 px-3 py-1 text-xs font-medium text-forest-600 shadow-elevation-raised">
          优先完成
        </span>
      </div>
      <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          ...
          <div className="mt-2 flex flex-wrap gap-2 text-sm text-ink-500">
            <span className="rounded-full bg-cream-100/80 px-3 py-1 shadow-elevation-raised">
