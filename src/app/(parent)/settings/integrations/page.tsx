...
export default function SettingsIntegrationsPage() {
  ...
  return (
    ...
    >
        ...
        {!selectedChildId && (
          <div className="rounded-radius-lg border border-dashed border-forest-200 bg-forest-50 px-space-4 py-5 text-center text-ui-sm text-forest-500">
            请选择一个孩子开始配置
          </div>
        )}
      ...
      <Card id="platform-binding" className="scroll-mt-4">
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="platform-name" className="mb-1 block text-ui-sm font-medium text-forest-700">
                平台
              </label>
              <select
                id="platform-name"
            ...
            {bindingError ? <p className="text-ui-sm text-coral-600">{bindingError}</p> : null}
          ...
          <div className="space-y-2">
            {(() => {
              ...
              return filteredAccounts.map((account) => {
                ...
                <div
                  key={account.id}
                  className="rounded-radius-lg border border-forest-100 bg-forest-50/70 px-space-4 py-space-3 text-ui-sm text-forest-600"
                >
                  {/* Header */}
                  ...
                  {editAccountId === account.id && (
                    <div className="mt-3 space-y-3 border-t border-forest-200 pt-3">
                      ...
                      {bindingError && <p className="text-ui-sm text-coral-600">{bindingError}</p>}
                  ...
                  {/* Expandable details */}
                  {isExpanded && (
                    <div className="mt-2 space-y-1 border-t border-forest-200 pt-2 text-ui-xs text-forest-500">
                  ...
                  {account.last_sync_error_summary ? (
                    <p className="mt-1 text-coral-600">{mapAuthError(account.last_sync_error_summary)}</p>
                  ) : null}
                  ...
                  {deleteConfirmId === account.id && (
                    <div className="mt-3 space-y-3 border-t border-coral-200 pt-3">
        ...
        {takeoverAccountId && (() => {
          ...
          return (
            ...
            >
              <div className="space-y-4">
                <div className="flex rounded-radius-md border border-forest-200 p-0.5">
                  <button
                    type="button"
                ...
                {takeoverMethod === "auto" ? (
                  ...
                  <div className="space-y-3">
                    <div className="rounded-radius-md bg-forest-50 px-space-3 py-2.5 text-ui-xs text-forest-600">
                    ...
                    <div className="flex items-center gap-2">
                      <code className="flex-1 rounded-radius-md bg-cream-100 px-space-3 py-space-2 text-ui-xs font-mono text-ink-700">
